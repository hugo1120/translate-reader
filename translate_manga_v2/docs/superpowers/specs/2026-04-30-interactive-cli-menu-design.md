...
> 历史文档：这是 `2026-04-30` 旧菜单设计。`2026-05-08` 的 `translate_manga_v2` 当前菜单已改为 `继续上次任务 / 新建任务 / 扫描并纠正错误 / 退出`，输出固定为 `<输入目录>/out`，并支持批量任务、自动纠错重跑和书系 Profile。当前用法以项目根 [start.md](../../../start.md) 为准。
