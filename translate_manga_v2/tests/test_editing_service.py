from translate_manga.core.editing.service import rerender_single_bubble, update_bubble_state
...
def test_rerender_single_bubble_updates_only_target_index(monkeypatch):
    ...
    monkeypatch.setattr("translate_manga.core.editing.service.run_saber_task", fake_run_saber_task)
...
def test_rerender_single_bubble_does_not_call_detect_or_translate(monkeypatch):
    ...
    monkeypatch.setattr("translate_manga.core.editing.service.detect_page", fake_detect, raising=False)
    monkeypatch.setattr("translate_manga.core.editing.service.translate_texts", fake_translate, raising=False)
    monkeypatch.setattr(
        "translate_manga.core.editing.service.run_saber_task",
