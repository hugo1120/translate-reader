...
from src.config.settings import load_settings, resolve_path_value, resolve_runtime_config
...
_SCRIPTS = {
    "detect": textwrap.dedent(
        ...
        result = get_bubble_detection_result_with_auto_directions(image)
        print(json.dumps({
    ...
    "preprocess": textwrap.dedent(
        ...
        detection = get_bubble_detection_result_with_auto_directions(image)
